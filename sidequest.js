/* =========================================================
   SIDE QUEST PHOTO DECK — image manifest
   Browsers can't list a folder's contents on their own, so this
   array is the index of what's in /sidequest. To add a photo:
     1. Drop the file into the /sidequest folder.
     2. Add a line below with its filename and a short alt text.
